...
| Can this candidate explain expected vs. actual behavior? | Yes — defect documentation includes steps, expected result, actual result, severity, and impact.                                                                                                 |
...
| Is the candidate honest about experience level?          | Yes — the portfolio clearly identifies the work as self-directed QA practice and beginner-level automation exposure.                                                                             |
...
| Selectors       | Uses stable `data-test` selectors in Page Object Model files and validation specs                                                                                         |
...
| CI Optimization | Workflow uses Chrome on the GitHub-hosted runner                                                                                                                          |
